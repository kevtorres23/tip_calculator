...
function TotalCard(props: TotalCardProps) {
    return (
        <View className="bg-white w-full items-center justify-center py-6 gap-6 px-8 rounded-3xl shadow-[0_3px_10px_rgb(0,0,0,0.2)] border border-gray-200">
            <View className="total-p-person text-center items-center box-content gap-2">
                ...
                <Text className="font-bold text-6xl text-slate-700">${props.totalPerPerson}</Text>
            </View>
            ...
            <View className="lower-totals flex-row w-full justify-between">
                <View className="flex-col items-center justify-center w-auto">
                    ...
                    <Text className="font-bold text-3xl text-blue-500">${props.totalPerPerson}</Text>
                </View>
                <View className="flex-col items-center justify-center w-auto">
